...
import {normalizeUser, normalizeQuantRanking, normalizeRatingsSummary} from "../data/normalizers";
import {QuantRankingDTO, RatingsSummaryDTO, UserDTO} from "../services/DTOs";
